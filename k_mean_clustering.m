...
for i=1:m
     ...
     CC(i,q) = 1;                                      #Assign 1 for point i to its closest centroid q (0 elsewhere)
end;

#Mean coordinate values for each space axis
for i=1:n_cl
...
#Matrix containing the final centroid coordinates
y = MU;                                                
